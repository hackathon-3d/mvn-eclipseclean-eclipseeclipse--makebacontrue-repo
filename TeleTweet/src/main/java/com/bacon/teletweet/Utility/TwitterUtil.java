...
public class TwitterUtil
{
	...
	public static void initAndAwaitAuthenticationResult(Activity c)
	{
		...
		new AsyncTask<Void, Void, RequestToken>(){
			...
			@Override public void onPostExecute(RequestToken tok)
			{
				...
				rqTok = tok;
				Intent i = new Intent(context, TwitterAuthenticationActivity.class);
	...
	public static void search(Query query, final SearchCallback scb)
	{
		...
		{
			//Um.
			//So I'm a fan of anonymous stuff, and I'd like if you could pass a listener in 
			//with each search call.
			//But even as-is, I'm not sure how twitter4j would handle multiple listeners.
			//Hence this hack.
